            ...
            while (response < 1 || response > 2) {
                ...
                if (response == 1) {
                    try {
                        ...
                        hotelOperationModule = new HotelOperationModule(roomSessionBeanRemote, roomRateSessionBeanRemote, roomTypeSessionBeanRemote, handleDateTimeSessionBeanRemote, roomAllocationReportSessionBeanRemote, allocationSessionBeanRemote, loggedInEmployee);
